 ...
 ***********************************************************************/
function __fifi() { 
__sprite_init__(this, fifi, 50, 48, 0, 0, 'Box', 52, 6, 44, 6, 44, ['img/fifi_0.png']);
}; var fifi = new __fifi();

function __sprite_10() { 
__sprite_init__(this, sprite_10, 40, 40, 0, 0, 'Box', 20, 0, 40, 0, 40, ['img/sprite_10_0.png']);
}; var sprite_10 = new __sprite_10();

function __sprite_49() { 
__sprite_init__(this, sprite_49, 40, 40, 0, 0, 'Box', 20, 0, 40, 0, 40, ['img/sprite_49_0.png']);
}; var sprite_49 = new __sprite_49();

function __spr_enemy() { 
__sprite_init__(this, spr_enemy, 40, 40, 0, 0, 'Box', 20, 0, 40, 0, 40, ['img/spr_enemy_0.png']);
}; var spr_enemy = new __spr_enemy();

function __spr_diamond() { 
__sprite_init__(this, spr_diamond, 40, 40, 0, 0, 'Box', 20, 0, 40, 0, 40, ['img/spr_diamond_0.png']);
 ...
 ***********************************************************************/
function __font_121() { 
__font_init__(this, font_121, 'Arial', 12, 0, 0)}; var font_121 = new __font_121();
 ...
 ***********************************************************************/
function __obj_fifi() {
__instance_init__(this, obj_fifi, null, 1, 0, fifi, 1, 0);
...
if ( keyboard_check_pressed( vk_space )) {
	new_bomb = instance_create( x + 20, y, obj_enemy );
}
}
};
...
with(this) {
this.other = this.place_meeting(this.x, this.y, object_11);
if(this.other != null) {
...
}; var obj_fifi = new __obj_fifi();

function __object_11() {
__instance_init__(this, object_11, null, 1, 0, sprite_10, 1, 1);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var object_11 = new __object_11();

function __object_50() {
__instance_init__(this, object_50, null, 1, 0, sprite_49, 1, 8);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var object_50 = new __object_50();

function __obj_enemy() {
__instance_init__(this, obj_enemy, null, 1, 0, spr_enemy, 1, 57);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
__instance_init__(this, obj_diamond, null, 1, 0, spr_diamond, 1, 58);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
this.on_collision = function() {
with(this) {
this.other = this.place_meeting(this.x, this.y, obj_fifi);
if(this.other != null) {
//Object destroyed
score = score + 1;
instance_destroy();
...
function __obj_score() {
__instance_init__(this, obj_score, null, 1, 0, null, 1, 63);
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var obj_score = new __obj_score();

function __obj_hud() {
__instance_init__(this, obj_hud, null, 1, 0, null, 1, 65);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
// HUD write text
//var score = 0;
draw_set_font(font_121);
draw_text(50, 50, "YOUR SCORE: " + score);
}
}
};
}; var obj_hud = new __obj_hud();
...
this.objects = [
[{o:object_11, x:300, y:400}],
[{o:object_11, x:260, y:400}],
[{o:object_11, x:220, y:400}],
[{o:object_11, x:200, y:400}],
[{o:object_11, x:160, y:400}],
[{o:object_11, x:120, y:400}],
[{o:object_11, x:0, y:0}],
[{o:object_11, x:0, y:40}],
[{o:object_11, x:0, y:80}],
[{o:object_11, x:0, y:120}],
[{o:object_11, x:0, y:140}],
[{o:object_11, x:0, y:180}],
[{o:object_11, x:0, y:220}],
[{o:object_11, x:0, y:260}],
[{o:object_11, x:0, y:300}],
[{o:object_11, x:0, y:320}],
[{o:object_11, x:0, y:360}],
[{o:object_11, x:0, y:400}],
[{o:object_11, x:40, y:400}],
[{o:object_11, x:60, y:400}],
[{o:object_11, x:100, y:400}],
[{o:object_11, x:40, y:0}],
[{o:object_11, x:60, y:0}],
[{o:object_11, x:100, y:0}],
[{o:object_11, x:140, y:0}],
[{o:object_11, x:180, y:0}],
[{o:object_11, x:220, y:0}],
[{o:object_11, x:260, y:0}],
[{o:object_11, x:300, y:0}],
[{o:object_11, x:300, y:40}],
[{o:object_11, x:300, y:80}],
[{o:object_11, x:300, y:120}],
[{o:object_11, x:300, y:160}],
[{o:object_11, x:300, y:200}],
[{o:object_11, x:300, y:240}],
[{o:object_11, x:260, y:200}],
[{o:object_11, x:220, y:200}],
[{o:object_11, x:180, y:200}],
[{o:object_11, x:140, y:200}],
[{o:object_11, x:120, y:200}],
[{o:object_11, x:100, y:200}],
[{o:object_11, x:80, y:200}],
[{o:object_11, x:80, y:240}],
[{o:object_11, x:80, y:280}],
[{o:object_11, x:120, y:280}],
[{o:object_11, x:160, y:280}],
[{o:object_11, x:160, y:320}],
[{o:object_11, x:240, y:360}],
[{o:object_11, x:240, y:320}],
[{o:object_11, x:280, y:320}],
[{o:object_11, x:300, y:360}],
[{o:object_11, x:300, y:320}],
[{o:object_50, x:300, y:280}],
[{o:obj_fifi, x:140, y:80}],
[{o:obj_diamond, x:260, y:160}],
[{o:obj_diamond, x:260, y:40}],
[{o:obj_diamond, x:40, y:40}],
[{o:obj_diamond, x:120, y:320}],
[{o:obj_score, x:280, y:20}],
[{o:obj_hud, x:80, y:20}]];
this.start = function() {
__room_start__(this, scene_3, 340, 440, 30, 128, 255, 255, null, 0, 0, 0, 640, 480, null, 50, 50);
};
}
var scene_3 = new __scene_3();
tu_scenes.push(scene_3);
tu_room_to_go = scene_3;
